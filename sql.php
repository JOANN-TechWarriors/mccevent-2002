...
// SQL to alter the mainevent_id column in main_event to BIGINT
$alter_main_event_id_sql = "ALTER TABLE main_event MODIFY COLUMN mainevent_id BIGINT(20) NOT NULL AUTO_INCREMENT";
...
// SQL to alter the subevent_id column in sub_event to BIGINT
$alter_sub_event_id_sql = "ALTER TABLE sub_event MODIFY COLUMN subevent_id BIGINT(20) NOT NULL AUTO_INCREMENT";
...
// SQL to alter the mainevent_id column in sub_event to BIGINT
$alter_sub_event_main_event_id_sql = "ALTER TABLE sub_event MODIFY COLUMN mainevent_id BIGINT(20) NOT NULL";
