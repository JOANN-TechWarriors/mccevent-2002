...
<body>
    <div class="container">
        ...
        <div class="profile-section">
            ...
            <div class="email-container">
                <form action="verify_gmail.php" method="POST">
                    <input type="email" placeholder="Enter your email" name="email" class="email-input" required>
                    <button class="send-button" type="submit" title="Send verification" id="sendButton">
                        <i class="arrow"></i>
                    </button>
                </form>
        ...
        <div class="recaptcha-container">
            <div class="g-recaptcha" data-sitekey="6LcsOX0qAAAAAMHHt5C_j6v9iH2hM6RUduOCmxqe"
