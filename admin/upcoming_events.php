                    ...
                    <div class="modal-body">
                        <form action="add_upcoming_event.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" name="eventstart" class="form-control" id="eventStart"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label for="eventEnd" class="form-label">End</label>
                                <input type="datetime-local" name="event_end" class="form-control" id="eventEnd"
                                    required>
                            </div>
                    ...
                    <div class="modal-body">
                        <form action="update-event.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="updateeventTitle" name="eventTitle"
                                    required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="datetime-local" class="form-control" id="updateeventEnd" name="eventEnd"
                                    required>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                                    id="cancelEventButton">Cancel</button>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response && response.success) {
                                    ...
                                    var eventToRemove = calendar.getEventById(
                                        event_id);
                                    if (eventToRemove) {
                    ...
                    if (response.success) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                $('#updateEventModal').modal('hide');
                                calendar
                            .refetchEvents(); // Refresh the events in FullCalendar
                            }
                        });
                    } else {
                        Swal.fire({
