      ...
      <div class="span12">
        ...
        { 
            ...
            <h2><?php echo $event_row['event_name']; ?></h2> 
               ...
               <tr>
             <td align="center">
            <h3>Votepoll Live View - <?php echo $s_event_row['event_name']; ?></h3> 
             </td>
              </tr>
...
$showContTP_query = $conn->query("select * from contestants WHERE subevent_id='$active_sub_event'") or die(mysql_error());
      while($showContTProw=$showContTP_query->fetch())   
      {
         ...
         if (!empty($showContTProw['AddOn'])) {
          $showaddon = "(".$showContTProw['AddOn'].")";
         } else {
          $showaddon = '';
         }
        ...
        <td>
            ...
            <h3 id="progress-animated"><?php  echo $showContTProw['fullname']; ?> <span class="text-muted"><?php echo $showaddon; ?></span></h3>
