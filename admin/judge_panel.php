...
while ($cont_row = $cont_query->fetch()) { 
    ...
    if (!empty($cont_row['AddOn'])) {
        $addon = "(".$cont_row['AddOn'].")";
    } else {
        $addon = '';
    }
    ?>
...
<?php    
    ...
    <?php if($getContestant_id==$con_idTab){?>
        <li class="active" ><a href="judge_panel.php?judge_ctr=<?php echo $judge_ctr; ?>&subevent_id=<?php echo $subevent_id; ?>&contestant_id=<?php echo $con_idTab;?>"><strong><?php echo $cont_row['fullname']; ?></strong><?php echo $addon; ?></a></li>
    <?php }else{  ?>
            <li class="" ><a href="judge_panel.php?judge_ctr=<?php echo $judge_ctr; ?>&subevent_id=<?php echo $subevent_id; ?>&contestant_id=<?php echo $con_idTab;?>"><?php echo $cont_row['fullname']; ?><?php echo $addon; ?></a></li>
